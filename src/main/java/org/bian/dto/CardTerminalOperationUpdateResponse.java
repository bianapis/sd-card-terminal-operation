...
/**
 * CardTerminalOperationUpdateResponse
 */
public class CardTerminalOperationUpdateResponse   {
  private String cardPOSTerminalOperatingSessionReference = null;

  private String cardPOSTerminalOperationUpdateTaskReference = null;

  private String cardTransactionPOSUpdateType = null;

  private Object cardTransactionPOSUpdateRecord = null;
  ...
  private Object cardPOSTerminalOperationUpdateTaskRecord = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier general-info: \"refers to the card update task\" 
   * @return cardPOSTerminalOperationUpdateTaskReference
  **/

  public String getCardPOSTerminalOperationUpdateTaskReference() {
    return cardPOSTerminalOperationUpdateTaskReference;
  }

  public void setCardPOSTerminalOperationUpdateTaskReference(String cardPOSTerminalOperationUpdateTaskReference) {
    this.cardPOSTerminalOperationUpdateTaskReference = cardPOSTerminalOperationUpdateTaskReference;
  }


  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text general-info: \"type of update request from POS\" 
   * @return cardTransactionPOSUpdateType
  **/

  public String getCardTransactionPOSUpdateType() {
    return cardTransactionPOSUpdateType;
  }

  public void setCardTransactionPOSUpdateType(String cardTransactionPOSUpdateType) {
    this.cardTransactionPOSUpdateType = cardTransactionPOSUpdateType;
  }


  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary general-info: \"details the update request\" 
   * @return cardTransactionPOSUpdateRecord
  **/

  public Object getCardTransactionPOSUpdateRecord() {
    return cardTransactionPOSUpdateRecord;
  }

  public void setCardTransactionPOSUpdateRecord(Object cardTransactionPOSUpdateRecord) {
    this.cardTransactionPOSUpdateRecord = cardTransactionPOSUpdateRecord;
  }
  ...
  **/
   ...
   * @return cardPOSTerminalOperationUpdateTaskRecord
  **/

  public Object getCardPOSTerminalOperationUpdateTaskRecord() {
    return cardPOSTerminalOperationUpdateTaskRecord;
  }

  public void setCardPOSTerminalOperationUpdateTaskRecord(Object cardPOSTerminalOperationUpdateTaskRecord) {
    this.cardPOSTerminalOperationUpdateTaskRecord = cardPOSTerminalOperationUpdateTaskRecord;
  }
