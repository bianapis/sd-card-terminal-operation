...
/**
 * CardTerminalOperationBatchResponse
 */
public class CardTerminalOperationBatchResponse   {
  private String cardPOSTerminalOperatingSessionReference = null;

  private String cardPOSTerminalOperationBatchCaptureTaskReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier general-info: \"refers to the card capture task\" 
   * @return cardPOSTerminalOperationBatchCaptureTaskReference
  **/

  public String getCardPOSTerminalOperationBatchCaptureTaskReference() {
    return cardPOSTerminalOperationBatchCaptureTaskReference;
  }

  public void setCardPOSTerminalOperationBatchCaptureTaskReference(String cardPOSTerminalOperationBatchCaptureTaskReference) {
    this.cardPOSTerminalOperationBatchCaptureTaskReference = cardPOSTerminalOperationBatchCaptureTaskReference;
  }
